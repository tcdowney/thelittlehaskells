...
#define	FIO4DIR0	(*(volatile uint8_t*)0x2009C081)
#define	FIO4DIR1	(*(volatile uint8_t*)0x2009C082)
#define	FIO4DIR2	(*(volatile uint8_t*)0x2009C083)
#define	FIO4DIR3	(*(volatile uint8_t*)0x2009C084)
...
#define	IO0IntEnR	(*(volatile uint32_t*)0x40028094)
...
#define	IO2IntEnR	(*(volatile uint32_t*)0x400280B4)
